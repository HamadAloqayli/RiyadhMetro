...
{
  header("Location:Card.php?errorInRegister");
  mysqli_close($con);
  exit();
}
...
$sqlFind = " SELECT * FROM card WHERE userId = '$id' AND role = '$role' AND status = 1 ";

$resultFind = mysqli_query($con,$sqlFind);

if(mysqli_num_rows($resultFind) > 0)
{
  header("Location:Card.php?haveCard");
  mysqli_close($con);
  exit();
}
    ...
    <div class="container" style="margin-top: 100px">
        <section class="price">
          <div class="page-section page-section--small">
            <h2 class="page-section__title text-center">CARD DETAIL</h2>
<br><br>
            <div class="price__panel-wrapper">

                      <div class="row">
                          <div class="col-md-6" style="display:flex ;justify-content: center; align-items:center">
                                <div id="cardShape"><div id="cardColor"></div><img src="img/logo.png" alt=""></div>
                          </div>
                    ...
                    <div id="cardContent">
                                  ...
                                  <p>Price: <?php echo $price ?> <small style="font-size: 12px">SR</small></p>
                    </div>
                          </div>
                      </div>
            ...
            <br>
                                 <div style="text-align: center">
                                          <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                            ...
                                            <input type="hidden" name="hosted_button_id" value="A7RWQA7K262CA">
