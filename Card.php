    ...
    <div class="container" style="margin-top: 100px">
        <section class="price">
          <div class="page-section page-section--small text-center">
            <h2 class="page-section__title">CARDS WE OFFER</h2>
            <p class="page-section__paragraph">A smart card that enables you to use the metro and enjoy more mobility with the card, as you can get a weekly, monthly, yearly card</p>
            ...
            <?php 
               if(isset($_GET['errorInRegister']))
                ...
                if(isset($_GET['haveCard']))
                            echo '
                            <div id="errorMsg" class="mt-3 text-danger text-center mb-4">
                                 You alredy have a card
                            </div>
                            <br><br>';
            ?>
            ...
            <div class="price__panel-wrapper">
                ...
                <div class="col-md-4">
                  <div class="panel text-center">
                    <div class="panel-heading">
                      <h4 class="price__title">1 WEEK</h4>
                      <h1 class="price__ammount"><span class="price__ammount--number">45</span>SR</h1>
                    </div>
                    <div class="panel-body">
                      <p>Unlimited use</p>
                      <p>Free wifi</p>
                      <p>Free parking for two hours</p>
                    </div>
                    <div>
                      <a class="panel__button" href="DetailCard.php?type=1week">GET THIS CARD</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="panel text-center">
                    <div class="panel-heading">
                      <h4 class="price__title">1 MONTH</h4>
                      <h1 class="price__ammount"><span class="price__ammount--number">180</span>SR</h1>
                    </div>
                    <div class="panel-body">
                      <p>Unlimited use</p>
                      <p>Free wifi</p>
                      <p>Free parking for six hours</p>
                    </div>
                    <div>
                      <a class="panel__button" href="DetailCard.php?type=1month">GET THIS CARD</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="panel text-center">
                    <div class="panel-heading">
                      <h4 class="price__title">3 MONTHS</h4>
                      <h1 class="price__ammount"><span class="price__ammount--number">540</span>SR</h1>
                    </div>
                    <div class="panel-body">
                      <p>Unlimited use</p>
                      <p>Free wifi</p>
                      <p>Free parking for nine hours</p>
                    </div>
                    <div>
                      <a class="panel__button" href="DetailCard.php?type=3month">GET THIS CARD</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-md-offset-2">
                  <div class="panel text-center">
                    <div class="panel-heading">
                      <h4 class="price__title">6 MONTHS</h4>
                      <h1 class="price__ammount"><span class="price__ammount--number">1080</span>SR</h1>
                    </div>
                    <div class="panel-body">
                      <p>Unlimited use</p>
                      <p>Free wifi</p>
                      <p>Free parking for fifteen hours</p>
                    </div>
                    <div>
                      <a class="panel__button" href="DetailCard.php?type=6month">GET THIS CARD</a>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="panel text-center">
                    <div class="panel-heading">
                      <h4 class="price__title">1 YEAR</h4>
                      <h1 class="price__ammount"><span class="price__ammount--number">2160</span>SR</h1>
                    </div>
                    <div class="panel-body">
                      <p>Unlimited use</p>
                      <p>Free wifi</p>
                      <p>Free parking for twenty hours</p>
                    </div>
                    <div>
                      <a class="panel__button" href="DetailCard.php?type=1year">GET THIS CARD</a>
                    </div>
                  </div>
                </div>
              </div>
